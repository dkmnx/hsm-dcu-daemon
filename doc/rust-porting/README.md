...
| Phase   | File                                                 | Crate(s)           | Duration   |
| ------- | ---------------------------------------------------- | ------------------ | ---------- |
| 1A      | [phase-1A-wisun-types.md](phase-1A-wisun-types.md)   | `wisun-types`      | 2-3 days   |
| 1B      | [phase-1B-spinel.md](phase-1B-spinel.md)             | `spinel`           | 5-7 days   |
| 1C      | [phase-1C-dcu-tun.md](phase-1C-dcu-tun.md)           | `dcu-tun`          | 3-4 days   |
| 1D      | [phase-1D-dcu-serial.md](phase-1D-dcu-serial.md)     | `dcu-serial`       | 3-4 days   |
| 2A      | [phase-2A-dcu-dbus.md](phase-2A-dcu-dbus.md)         | `dcu-dbus`         | 5-7 days   |
| 2B      | [phase-2B-dcuctl.md](phase-2B-dcuctl.md)             | `dcuctl`           | 5-7 days   |
| 3A      | [phase-3A-daemon-core.md](phase-3A-daemon-core.md)   | `dcu-daemon`       | 14-21 days |
| 3B      | [phase-3B-spinel-tasks.md](phase-3B-spinel-tasks.md) | `dcu-daemon` tasks | 7-10 days  |
| 4A      | [phase-4A-mock-ncp.md](phase-4A-mock-ncp.md)         | `dcu-mock`         | 3-5 days   |
| 4B      | [phase-4B-e2e-tests.md](phase-4B-e2e-tests.md)       | Integration tests  | 3-5 days   |
